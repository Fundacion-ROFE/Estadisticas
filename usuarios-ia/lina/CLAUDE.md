...
> `https://github.com/Fundacion-ROFE/Estadisticas/tree/main/usuarios-ia/lina`
...
## Rol / área
Coordinación de Fundación ROFÉ: crecimiento y búsquedas estratégicas (función asumida por
falta de personal dedicado), más supervisión general del rollout de estas instancias de
`usuarios-ia/` para el resto del equipo (Astrid, Sandra, Rocío, Cristian). No es parte del
equipo técnico de desarrollo — esta carpeta es una instancia liviana para consultar datos y
apoyarse en herramientas de decisión sin necesitar el contexto técnico completo del repo
(`CLAUDE.md` de la raíz, con scripts/credenciales/PII, sigue siendo de uso técnico con Samuel).
...
(nombre/cédula/email/celular) desde esta carpeta puntual.

## Skills habilitados
- `evaluar` — antes de arrancar una tarea nueva, estima complejidad y recomienda modelo/prompt.
- `consejo-ligero`, `consejo-medio`, `consejo-profundo` — los 3 niveles de consejo simulado
  (optimista/escéptico/economista/juez) para decisiones estratégicas o de coordinación, con
  costo creciente de aislamiento en subagentes según qué tan reversible/riesgosa sea la
  decisión. Encajan directo con su función de crecimiento/búsquedas estratégicas.

## Restricciones específicas
Ninguna adicional a las fijas de abajo. Si en el uso real aparece una necesidad de escritura
(por ejemplo, disparar un envío real de correos de una campaña) esa acción sigue siendo del
repo principal con Samuel, no de esta carpeta — ver "Límites de autonomía" abajo.
...
- Crear, modificar o desconectar workflows de n8n, credenciales, o cualquier archivo del
  repo de gobernanza fuera de su propia carpeta (`usuarios-ia/lina/`).

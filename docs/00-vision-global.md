...
| Panel de Datos Supabase | [[panel-datos-etl]] | **Fases 0-2 completadas (2026-07-09):** proyecto `panel-datos-rofe`, RLS verificada, carga real 1.059/9/5.818 (cuadra ≈775 JC + 283 MR), workflow n8n `q10-sync-supabase` activo (diario 9:45), **sociodemográficos cargados** (775 con género/edad/ciudad/grupo + emprendimiento 4 categorías desde BD monitorias) y **5 vistas públicas de agregados** listas para el frontend. Siguiente: verificar 1ª corrida automática, Fase 3 (Next.js/Netlify), retirados en Supabase, campo programa JC/MR |
